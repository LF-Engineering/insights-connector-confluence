# insights-connector-confluence
Confluence data source V2

- run `make swagger` to generate models.
- run `make` to build app.
- run `./scripts/example_run.sh` to try it.
- example [JSON](https://github.com/LF-Engineering/insights-connector-confluence/blob/main/exampleOutput.json) generated by this tool:
```
{
  "DataSource": {
    "Name": "Confluence",
